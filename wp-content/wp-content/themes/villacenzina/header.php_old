   	...
   	<div id="container">
        ...
        <div class="row slider">        
            ...
            <div class="row menu">
                ...
                <a href="https://www.facebook.com/Villacenzinait-1423594471235147/?fref=ts" target="_blank"><img class="icon-fb" src="<?php echo get_bloginfo('template_url');?>/img/fb.png"></a>
                    <ul class="title-area">
                        <li class="name"></li>
