	 ...
	 <?php 
        ...
        <div class="container-tariffe">            
            <div class="row tariffe tipoligia">
                <div class="small-12 large-12 columns"><h2><?php echo get_cat_name(5);?></h2></div>
             </div>            
            <div class="row tariffe descrizione">
                <div class="small-12 large-12 columns"><?php echo category_description(5); ?></div>
             </div>       
            <!-- Ciclo prezzi --> 
            <div class="row tariffe prezzi">
                ...
                <table role="grid">
                 ...
                 <tbody>    
                <?php 
                   $loop_tipoligia = array('post_type' => 'tariffe', 'cat' => '5', 'order' => 'ASC',);
        ...
        <div class="container-tariffe">        
            <div class="row tariffe tipoligia">
                <div class="small-12 large-12 columns"><h2><?php echo get_cat_name(6);?></h2></div>
             </div>            
            <div class="row tariffe descrizione">
                <div class="small-12 large-12 columns"><?php echo category_description(6); ?></div>
             </div>       
            <!-- Ciclo prezzi --> 
            <div class="row tariffe prezzi">
                <div class="small-12 large-12 columns">
                <table role="grid">
                 ...
                 <tbody>  
                <?php 
                   $loop_tipoligia = array('post_type' => 'tariffe', 'cat' => '6', 'order' => 'ASC',);
                   $list_tipoliga_A = new WP_Query($loop_tipoligia); 
                   while($list_tipoliga_A->have_posts()) : $list_tipoliga_A->the_post();
                ?>	   
                	<tr>
        ...
        <div class="container-tariffe">   
            <div class="row tariffe tipoligia">
                <div class="small-12 large-12 columns"><h2><?php echo get_cat_name(7);?></h2></div>
             </div>            
            <div class="row tariffe descrizione">
                <div class="small-12 large-12 columns"><?php echo category_description(7); ?></div>
             </div>       
            <!-- Ciclo prezzi --> 
            <div class="row tariffe prezzi">
                <div class="small-12 large-12 columns">
                <table role="grid">
                 ...
                 <tbody>  
                <?php 
                   $loop_tipoligia = array('post_type' => 'tariffe', 'cat' => '7', 'order' => 'ASC',);
                   $list_tipoliga_A = new WP_Query($loop_tipoligia); 
                   while($list_tipoliga_A->have_posts()) : $list_tipoliga_A->the_post();
                ?>	   
                	<tr>
